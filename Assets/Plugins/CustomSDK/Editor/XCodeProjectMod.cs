...
public class XCodeProjectMod
{
    ...
    public static void OnPostprocessBuild(BuildTarget buildTarget, string path)
    {
        ...
        string fromPath = Path.Combine(Directory.GetParent(Application.dataPath).FullName, "ios_icon");
        string targetPath = Path.Combine(path, "Unity-iPhone/Images.xcassets/AppIcon.appiconset");
        CopyAndReplaceDirectory(fromPath, targetPath);
        ...
        //rootDict.SetString("NSPhotoLibraryAddUsageDescription", "App需要您的同意,才能保存照片");
